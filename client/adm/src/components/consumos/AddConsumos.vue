<template>
  <main>
    ...
    <div class="shadow bg-light rounded-3 p-4 my-5 mx-auto w-50">
      <form>
        <div class="container">
          <div class="row my-2">
        ...
        <div class="col col-sm-4 col-md-6">
          ...
          <div class="mt-3 mx-auto col col-sm-4 col-md-6">
        ...
        <div class="mx-auto mt-3 col col-sm-4 col-md-6">
        ...
        <div class="mt-3 col col-sm-4 col-md-6">
      ...
      <button class="button mt-3" @click="saveConsumo">
        Cadastrar
      </button>
    </div>
      </div>
